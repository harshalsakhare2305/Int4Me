  ...
  return (
    <>
      <div className="flex p-4 bg-blue-400 justify-between items-center shadow-xl">
        <div className="text-4xl font-bold text-white">Int4Me</div>
      ...
      <div className="bg-gray-800 text-white p-24">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-between">
            ...
            <div className="w-full sm:w-1/3 mb-6 sm:mb-0">
              ...
              <div className="flex space-x-4">
                <a
                  href="https://www.linkedin.com/in/harshal-sakhare-008b93256/"
                ...
                <a
                  href="https://github.com/harshalsakhare2305"
                  className="text-3xl hover:scale-125 transition-all ease-in-out"
                >
                  <FaSquareGithub />
                </a>
          ...
          <div className="text-center mt-8">
            <p>&copy; 2025 Int4Me. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
